      ...
      <Card className="border-gray-200">
        <CardContent className="p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Patient Intake Workflows</h2>
          </div>
          <p className="text-sm text-gray-600 mb-6">Design automated workflows for patient intake processes</p>
