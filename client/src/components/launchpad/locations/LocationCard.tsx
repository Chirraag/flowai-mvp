...
export default function LocationCard({
  ...
  return (
    <Card className="border border-slate-200/70 bg-white rounded-2xl overflow-hidden shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-[1px] focus-within:shadow-md focus-within:-translate-y-[1px]" data-location-card>
      <CardHeader className="cursor-pointer bg-[#eef2ff] text-[#1C275E] px-5 py-4 border-b border-slate-200 transition-colors hover:bg-[#e0e7ff]" onClick={onToggleMinimize}>
      ...
      {!isMinimized && (
        ...
        <div className="space-y-2 mb-4">
          <Label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Location Name</Label>
          <Input
        ...
        <div className="space-y-2 mb-4">
          <Label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Location ID</Label>
          <Input
            className="h-10 border-[#cbd5e1] focus:border-[#0d9488] focus:ring-2 focus:ring-[#0d9488]/20 transition"
        ...
        <div className="grid grid-cols-5 gap-3 mb-4">
          ...
          <div className="space-y-2 col-span-2">
            <Label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Zip</Label>
            <Input
              className="h-10 border-[#cbd5e1] focus:border-[#0d9488] focus:ring-2 focus:ring-[#0d9488]/20 transition"
              placeholder="Zip"
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Weekday Hours</Label>
            <Input
              className="h-10 border-[#cbd5e1] focus:border-[#0d9488] focus:ring-2 focus:ring-[#0d9488]/20 transition"
          ...
          <div className="space-y-2">
            <Label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Weekend Hours</Label>
            <Input
              className="h-10 border-[#cbd5e1] focus:border-[#0d9488] focus:ring-2 focus:ring-[#0d9488]/20 transition"
        ...
        <div className="space-y-2 mb-4">
          <Label className="text-xs font-semibold text-slate-600 uppercase tracking-wide">Parking Directions</Label>
          <Textarea
