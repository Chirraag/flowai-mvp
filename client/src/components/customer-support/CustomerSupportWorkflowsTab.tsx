...
interface CustomerSupportWorkflowsTabProps {
  readOnly?: boolean;
}
...
const CustomerSupportWorkflowsTab = forwardRef<CustomerSupportWorkflowsTabHandle, CustomerSupportWorkflowsTabProps>(({ readOnly = false }, ref) => {
  ...
  return (
    <div className="space-y-6">
      {/* Enhanced Customer Support Workflows Card */}
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-200 text-sm mt-1">Design and configure customer support automation workflows</p>
              </div>
            </div>
